...
const Login = () => {
    ...
    function postData(e) {
        ...
        if (values.email === undefined || values.password === undefined) {
            ...
            axios.post("http://localhost:9009/login", item).then((res) => {
    ...
    const googleData = async googleData => {
        ...
        axios.post("http://localhost:9009/google", response).then((res) => {
            if (res.data.success === true) {
                localStorage.setItem('token', res.data.token);
                setTimeout(() => {
                    window.location.reload(true)
    ...
    return (
        <div className='container-fluid' >
         ...
         <div>
            <QRCode
               value="http://localhost:9009"style={{ marginRight: 50 }}/>
            <p>Tutorialspoint </p>
         </div>
          </div> */}
                            ...
                            <div class="card" style={{ borderradius: "1rem" }}>
                                <div class="row g-0">
                                    <div class="col-md-6 col-lg-5 d-none d-md-block">
                                        <img
                                            src="https://www.frontlist.in/storage/uploads/2021/08/best-history-books-to-read-2021.jpg"
